...
TEMPLATE_DIR = Path.joinpath(BASE_DIR,'templatesA')
...
SECRET_KEY = 'django-insecure--xhlm_9k(tb_j#v8qka8d=yxcnb^a8-!lbhoaep%anphyqhz7h'
...
LOGIN_URL = '/basic_appA/user_login'
